...
const Videos = () => {
    ...
    return(
        <div>
            ...
            <h2>To see videos of cover songs and other fun stuff, go to <a href="https://www.youtube.com/user/aspreck/videos" target="_blank" rel="noreferrer">my YouTube library.</a></h2>
            <h1>Demon Train</h1>
            <h4>12/22/2018</h4>
            {/*Video*/}
